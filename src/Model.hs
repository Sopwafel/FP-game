...
data Enemy  = Enemy  {location :: Point, health :: Int, image :: Picture, speed :: Vector, bullet :: Bullet} 
testEnemy = Enemy {location = (600, 0), health = 5, image = Arc 130.0 230.0 20.0, speed = (0.0, 0.0), bullet = enemyBullet}
